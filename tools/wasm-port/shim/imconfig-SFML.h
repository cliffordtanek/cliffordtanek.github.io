// =============================================================================
//  Stand-in for imgui-SFML's imconfig-SFML.h.
//
//  imconfig.h includes this by name, and the project's code relies on the
//  implicit ImVec2 <-> sf::Vector2 and ImVec4 <-> sf::Color conversions it
//  installs, so the shim has to provide the same ones against the shim types.
// =============================================================================
#pragma once
